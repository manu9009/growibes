 ...
 * @endcode
 */
$settings['hash_salt'] = 'ON34n3ofbm4wq9H5AspMPJtPSsKNHMb9-ayid2FPSDbazwPhi3ZhkUEdcHmD1q77d9zJdO790g';
...
# Remove ability for visitors to register.
$config['user.settings']['register'] = "admin_only";


# Settings for logging.
$config['syslog.settings']['identity'] = "drupal";
$config['syslog.settings']['facility'] = 128;
$config['syslog.settings']['format'] = '"base-url":"!base_url","timestamp-seconds":!timestamp,"type":"!type","ip":"!ip","request-uri":"!request_uri","referer":"!referer","severity":"!severity","uid":"!uid","link":"!link","message":"!message"';
